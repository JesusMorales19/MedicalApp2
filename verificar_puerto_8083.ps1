# Script para verificar puerto 8083
Write-Host "=== Verificando Puerto 8083 ===" -ForegroundColor Green

$puerto = 8083

# Verificar si el puerto está en uso localmente
Write-Host "`n1. Verificando puerto 8083 localmente..." -ForegroundColor Yellow
try {
...
Write-Host "`n2. Probando puerto 8083 en diferentes IPs..." -ForegroundColor Yellow
...
if ($conexionesEncontradas.Count -gt 0) {
    Write-Host "Conexiones encontradas en puerto 8083:" -ForegroundColor Green
    ...
    Write-Host "No se encontraron conexiones en puerto 8083" -ForegroundColor Red
...
Write-Host "Puerto configurado: 8083" -ForegroundColor White
Write-Host "URL para TV: ws://[IP_DEL_CELULAR]:8083" -ForegroundColor White 